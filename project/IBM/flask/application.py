...
with open(r"C:\Users\tejab\OneDrive\Desktop\TRAFFICELLIGENCE_PROJECT\flask\model.pkl", 'rb') as file:
    model = pickle.load(file)

with open(r"C:\Users\tejab\OneDrive\Desktop\TRAFFICELLIGENCE_PROJECT\flask\encoder.pkl", 'rb') as file:
